...
**Version:** 3.0.0 (Azeroth Explorer — Pacific theater)  
**Globe:** v3 · Built 2026-06-21
...
Initial release: Azeroth Pacific cluster, major islands, and minor isles. Opposite-hemisphere worlds (Outland, Draenor, etc.) ship in future releases.
